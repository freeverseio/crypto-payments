 ...
 * - in the 'relayedBuyNow' method, the operator is the msg.sender (the operator therefore signs the TX),
 *   and the buyer's EIP712-signature of the BuyNowInput struct is provided as input to the call.
 */
